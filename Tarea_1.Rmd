...
-   *Restaurante i3*, 17000€ la comida, además los invitados podrían ir en coche o autobús, pero al estar más cerca que el restaurante más económico, supondría un coste de 500€ por cada autobús (se necesitarían 3 autobuses), además si quieren contratar el servicio de barra libre supondría un incremento de 8000€.
